...
- Build and publish a site right here in this chat — nothing to install. Sites go live at <handle>.simple-host.app/<name>/ (every account has its own address) in about a minute.
